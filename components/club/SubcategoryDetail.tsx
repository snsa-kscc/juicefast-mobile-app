...
export function SubcategoryDetail({ 
  ...
  const groupedItems = items.reduce<Record<string, ProcessedClubItem[]>>((acc, item) => {
  ...
  const headerImageUrl = featuredImageUrl || (items.length > 0 ? items[0].imageUrl : undefined);
