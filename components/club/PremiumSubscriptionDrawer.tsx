...
export function PremiumSubscriptionDrawer({ children }: PremiumSubscriptionDrawerProps) {
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.description}>
              Get access to exclusive content, detailed analytics, and premium insights
            </Text>
            ...
            <View style={styles.featuresContainer}>
              ...
              <View style={styles.feature}>
                <Ionicons name="checkmark-circle" size={24} color="#10B981" />
                <Text style={styles.featureText}>Better wellness predictions</Text>
              </View>
            </View>

            <TouchableOpacity style={styles.subscribeButton} onPress={closeDrawer}>
