...
export function PremiumSubscriptionDrawer({
  ...
  return (
    <>
      ...
      <Modal
        visible={isVisible}
        transparent={Platform.OS === "android" || Platform.OS === "web"}
        animationType="slide"
        presentationStyle={Platform.OS === "ios" ? "pageSheet" : undefined}
        onRequestClose={closeDrawer}
      >
        <View
          className={`flex-1 ${Platform.OS === "web" ? "items-center" : ""}`}
        >
          <SafeAreaView
            className={`flex-1 ${Platform.OS === "web" ? "bg-jf-gray max-w-xl w-full" : "bg-jf-gray"}`}
          >
              ...
              <View className="px-5 pt-6 pb-8">
                ...
                <View className="mb-6">
                  ...
                  >
                    ...
                    <Text className="text-xs font-lufga text-gray-500 leading-4">
                      Billed monthly. Get started right away with flexible
                      monthly payments.
                    </Text>
                  </TouchableOpacity>
                </View>
