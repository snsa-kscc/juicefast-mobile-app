...
export function QuizStart({ onStart }: QuizStartProps) {
  ...
  return (
    <ScrollView
      ...
      contentContainerClassName="justify-center items-center px-6 min-h-full"
      showsVerticalScrollIndicator={false}
    >
      <View className="w-full max-w-sm py-8">
        {/* App logo */}
        <View className="items-center mb-6">
          <View className="w-20 h-20 rounded-2xl items-center justify-center bg-[#231f20]">
            <Image
