...
export const MealIcon = ({ color = "#000000" }: IconProps) => (
...
export const StepsIcon = ({ color = "#000000" }: IconProps) => (
  <Svg width="36" height="36" viewBox="0 0 44 44" fill="none">
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const MindfulnessIcon = ({ color = "#000000" }: IconProps) => (
  <Svg width="36" height="36" viewBox="0 0 44 44" fill="none">
    <Path
...
export const SleepIcon = ({ color = "#000000" }: IconProps) => (
  <Svg width="36" height="36" viewBox="0 0 44 44" fill="none">
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const WaterIcon = ({ color = "#000000" }: IconProps) => (
  <Svg width="36" height="36" viewBox="0 0 44 44" fill="none">
    <Path
