...
import { getItemsByCategory, getSubcategoryData, WELLNESS_CATEGORIES } from '@/utils/clubData';
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.errorContainer}>
          ...
          <Text style={styles.errorText}>The wellness category you're looking for doesn't exist.</Text>
          <TouchableOpacity 
            onPress={() => router.back()} 
