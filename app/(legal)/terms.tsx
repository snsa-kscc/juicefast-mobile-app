  ...
  return (
    <View className="flex-1 bg-amber-50">
      ...
      <ScrollView className="flex-1 px-6 py-6">
        ...
        {/* Section 2 */}
        <View className="mb-6">
          <Text className="text-lg font-bold mb-2">2. Use of Service</Text>
        ...
        {/* Section 4 */}
        <View className="mb-6">
          <Text className="text-lg font-bold mb-2">4. Health Disclaimer</Text>
          <Text className="text-base text-gray-700 leading-6">
        ...
        {/* Section 5 */}
        <View className="mb-6">
          <Text className="text-lg font-bold mb-2">5. Content Ownership</Text>
          <Text className="text-base text-gray-700 leading-6">
        ...
        {/* Section 9 */}
        <View className="mb-6">
          <Text className="text-lg font-bold mb-2">9. Changes to Terms</Text>
          <Text className="text-base text-gray-700 leading-6">
